...
interface NotificationReceptionistImpl {
...
interface NotificationReceptionist {
...
interface BookmarkReceptionist {
...
interface EditorSelection {
    bookmarkReceptionist: BookmarkReceptionist;
...
interface WindowReceptionistImpl {
...
interface EditorReceptionistEventMap {
    'AddEditor': {
        editor: Editor;
    };
    'RemoveEditor': {
...
interface EditorReceptionist extends Observable<EditorReceptionistEventMap> {
    $: DomQueryConstructor;
    ...
    i18n: I18n;
    suffix: string;
    add(this: EditorReceptionist, editor: Editor): Editor;
    addI18n: (code: string, item: Record<string, string>) => void;
    createEditor(this: EditorReceptionist, id: string, settings: RawEditorSettings): Editor;
    execCommand(this: EditorReceptionist, cmd: string, ui: boolean, value: any): boolean;
    get(this: EditorReceptionist): Editor[];
    get(this: EditorReceptionist, id: number | string): Editor;
    init(this: EditorReceptionist, settings: RawEditorSettings): Promise<Editor[]>;
    overrideDefaults(this: EditorReceptionist, defaultSettings: Partial<RawEditorSettings>): void;
    remove(this: EditorReceptionist): void;
    remove(this: EditorReceptionist, selector: string | Editor): Editor | void;
    setActive(this: EditorReceptionist, editor: Editor): void;
    setup(this: EditorReceptionist): void;
    translate: (text: Untranslated) => TranslatedString;
    triggerSave: () => void;
    _setBaseUrl(this: EditorReceptionist, baseUrl: string): void;
}
...
declare type PluginReceptionist = AddOnReceptionist<Plugin>;
...
interface Theme {
    ...
    getNotificationReceptionistImpl?: () => NotificationReceptionistImpl;
    getWindowReceptionistImpl?: () => WindowReceptionistImpl;
}
declare type ThemeReceptionist = AddOnReceptionist<Theme>;
interface EditorConstructor {
    readonly prototype: Editor;
    new (id: string, settings: RawEditorSettings, editorReceptionist: EditorReceptionist): Editor;
}
declare class Editor implements EditorObservable {
    ...
    suffix: string;
    editorReceptionist: EditorReceptionist;
    inline: boolean;
    isNotDirty: boolean;
    callbackLookup: any;
    ...
    theme: Theme;
    undoReceptionist: UndoReceptionist;
    validate: boolean;
    windowReceptionist: WindowReceptionist;
    _beforeUnload: () => void;
    ...
    constructor(id: string, settings: RawEditorSettings, editorReceptionist: EditorReceptionist);
    render(): void;
...
interface AddOnReceptionistNamespace {
    new <T>(): AddOnReceptionist<T>;
    language: string | undefined;
    languageLoad: boolean;
    baseURL: string;
    PluginReceptionist: PluginReceptionist;
    ThemeReceptionist: ThemeReceptionist;
}
interface BookmarkReceptionistNamespace {
    (selection: EditorSelection): BookmarkReceptionist;
...
interface TinyMCE extends EditorReceptionist {
    geom: {
        Rect: Rect;
    };
    util: {
    ...
    dom: {
        ...
        BookmarkReceptionist: BookmarkReceptionistNamespace;
    ...
    AddOnReceptionist: AddOnReceptionistNamespace;
    ...
    Env: Env;
    FocusReceptionist: FocusReceptionist;
    Formatter: new (editor: Editor) => Formatter;
    NotificationReceptionist: new (editor: Editor) => NotificationReceptionist;
    Shortcuts: ShortcutsConstructor;
    UndoReceptionist: new (editor: Editor) => UndoReceptionist;
    WindowReceptionist: new (editor: Editor) => WindowReceptionist;
    DOM: DOMUtils;
    ScriptLoader: ScriptLoader;
    PluginReceptionist: PluginReceptionist;
    ThemeReceptionist: ThemeReceptionist;
    IconReceptionist: IconReceptionist;
    Resource: Resource;
    trim: Tools['trim'];
    isArray: Tools['isArray'];
    is: Tools['is'];
...
export { AddOnReceptionist, Annotator, AstNode, Bookmark, BookmarkReceptionist, Class, Color, ControlSelection, DOMUtils, Delay, DomParser, DomParserSettings, DomQuery, DomSerializer, DomSerializerSettings, DomTreeWalker, Editor, EditorCommands, EditorEvent, EditorReceptionist, EditorModeApi, EditorObservable, EditorSelection, EditorSettings, Entities, Env, EventDispatcher, EventUtils, EventTypes_d as Events, FocusReceptionist, Format_d as Formats, Formatter, GeomRect, HtmlSerializer, HtmlSerializerSettings, I18n, IconReceptionist, JSONUtils as JSON, JSONP, JSONRequest, JSONRequestArgs, JSONRequestSettings, NotificationApi, NotificationReceptionist, NotificationSpec, Observable, Plugin, PluginReceptionist, RangeUtils, RawEditorSettings, Rect, Resource, SaxParser, SaxParserSettings, Schema, SchemaSettings, ScriptLoader, Shortcuts, StyleSheetLoader, Styles, TextSeeker, Theme, ThemeReceptionist, TinyMCE, Tools, URI, Ui_d as Ui, UndoReceptionist, VK, WindowReceptionist, Writer, WriterSettings, XHR, XHRSettings };
