...
(function () {
    ...
    var global$6 = tinymce.util.Tools.resolve('tinymce.PluginReceptionist');
    ...
    var alertErr = function (editor) {
      return function (message) {
        editor.windowReceptionist.alert(message);
      };
    };
    ...
    var Dialog = function (editor) {
      ...
      var open = function () {
        collect(editor).then(makeDialog(helpers)).then(editor.windowReceptionist.open);
      };
      return { open: open };
    };
