...
(function () {
    ...
    var global$3 = tinymce.util.Tools.resolve('tinymce.PluginReceptionist');
    ...
    var BarReceptionist = function (wire) {
    ...
    var create$3 = function (wire, resizing, lazySizing) {
      ...
      var Receptionist = BarReceptionist(wire);
      var events = create$4({
        beforeResize: Event([
          'table',
          'type'
      ...
      Receptionist.events.adjustHeight.bind(function (event) {
      ...
      Receptionist.events.startAdjust.bind(function (_event) {
        events.trigger.startDrag();
      });
      Receptionist.events.adjustWidth.bind(function (event) {
        var table = event.table;
      ...
      return {
        on: Receptionist.on,
        off: Receptionist.off,
        hideBars: Receptionist.hideBars,
        showBars: Receptionist.showBars,
        destroy: Receptionist.destroy,
        events: events.registry
      };
    };
    ...
    var insert = function (editor, columns, rows, colHeaders, rowHeaders) {
      ...
      editor.undoReceptionist.ignore(function () {
    ...
    var open$2 = function (editor, selections) {
      ...
      editor.windowReceptionist.open({
