...
(function () {
    ...
    var global$4 = tinymce.util.Tools.resolve('tinymce.PluginReceptionist');
    ...
    var open = function (editor, templateList) {
      var createTemplates = function () {
        if (!templateList || templateList.length === 0) {
          ...
          editor.notificationReceptionist.open({
            text: message,
            type: 'info'
          });
          return Optional.none();
      ...
      var loadFailedAlert = function (api) {
        editor.windowReceptionist.alert('Could not load the specified template.', function () {
      ...
      var openDialog = function (templates) {
        ...
        var dialogApi = editor.windowReceptionist.open(buildDialogSpec([], {
          template: '',
          preview: ''
        }));
