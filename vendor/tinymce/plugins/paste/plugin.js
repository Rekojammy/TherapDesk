...
(function () {
    ...
    var global$b = tinymce.util.Tools.resolve('tinymce.PluginReceptionist');
    ...
    var createImage = function (editor, url, pasteHtmlFn) {
      editor.undoReceptionist.extra(function () {
    ...
    var registerEventHandlers = function (editor, pasteBin, pasteFormat) {
      ...
      var insertClipboardContent = function (editor, clipboardContent, isKeyBoardPaste, plainTextMode, internal) {
        ...
        if (pasteBin.isDefaultContent(content)) {
          if (!isKeyBoardPaste) {
            editor.windowReceptionist.alert('Please use Ctrl+V/Cmd+V keyboard shortcuts to paste contents.');
          }
          return;
        }
        if (plainTextMode) {
