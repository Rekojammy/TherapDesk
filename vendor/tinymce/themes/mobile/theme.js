...
(function () {
    ...
    var focusShifted = prefixName('focusReceptionist.shifted');
    ...
    var global$4 = tinymce.util.Tools.resolve('tinymce.ThemeReceptionist');
    ...
    var typical = function (infoSchema, stateInit, getKeydownRules, getKeyupRules, optFocusIn) {
      var schema = function () {
        return infoSchema.concat([
          defaulted('focusReceptionist', dom$2()),
    ...
    var create$4 = function (cyclicField) {
      ...
      var findCurrent = function (component, tabbingConfig) {
        return tabbingConfig.focusReceptionist.get(component).bind(function (elem) {
      ...
      var focusIn = function (component, tabbingConfig, _tabbingState) {
        findInitial(component, tabbingConfig).each(function (target) {
          tabbingConfig.focusReceptionist.set(component, target);
        });
      };
    ...
    var use = function (move, component, simulatedEvent, config, state) {
      var outcome = config.focusReceptionist.get(component).bind(function (focused) {
        return move(component.element, focused, config, state);
      });
      return outcome.map(function (newFocus) {
        config.focusReceptionist.set(component, newFocus);
        return true;
      });
    };
    var north = useV;
    ...
    var focusIn$3 = function (component, gridConfig, _gridState) {
      descendant(component.element, gridConfig.selector).each(function (first) {
        gridConfig.focusReceptionist.set(component, first);
      });
    };
    var findCurrent$1 = function (component, gridConfig) {
      return gridConfig.focusReceptionist.get(component).bind(function (elem) {
    ...
    var findCurrent = function (component, flowConfig) {
      return flowConfig.focusReceptionist.get(component).bind(function (elem) {
    ...
    var focusIn$2 = function (component, flowConfig, _state) {
      flowConfig.getInitial(component).orThunk(function () {
        ...
        flowConfig.focusReceptionist.set(component, first);
      });
    };
    ...
    var focusIn$1 = function (component, matrixConfig, _state) {
      ...
      focused.each(function (cell) {
        matrixConfig.focusReceptionist.set(component, cell);
      });
    };
    ...
    var execute = function (component, simulatedEvent, menuConfig) {
      return menuConfig.focusReceptionist.get(component).bind(function (focused) {
    ...
    var focusIn = function (component, menuConfig, _state) {
      descendant(component.element, menuConfig.selector).each(function (first) {
        menuConfig.focusReceptionist.set(component, first);
      });
    };
    ...
    var edgePart = function (name) {
      return optional({
        ...
        overrides: function (detail) {
          var action = detail.model.Receptionist.edgeActions[name];
    ...
    var spectrumPart = required({
      ...
      overrides: function (detail) {
        ...
        var model = modelDetail.Receptionist;
    ...
    var onLoad$4 = function (component, repConfig, repState) {
      repConfig.store.Receptionist.onLoad(component, repConfig, repState);
    };
    var onUnload$2 = function (component, repConfig, repState) {
      repConfig.store.Receptionist.onUnload(component, repConfig, repState);
    };
    var setValue$3 = function (component, repConfig, repState, data) {
      repConfig.store.Receptionist.setValue(component, repConfig, repState, data);
    };
    var getValue$4 = function (component, repConfig, repState) {
      return repConfig.store.Receptionist.getValue(component, repConfig, repState);
    };
    ...
    var init$4 = function (spec) {
      return spec.store.Receptionist.state(spec);
    };
    ...
    var SliderSchema = [
      ...
      requiredOf('model', choose$1('mode', {
        x: [
          ...
          output('Receptionist', HorizontalModel)
        ],
        y: [
          defaulted('minY', 0),
          defaulted('maxY', 100),
          ...
          required$1('getInitialValue'),
          output('Receptionist', VerticalModel)
        ],
        xy: [
          defaulted('minX', 0),
          defaulted('maxX', 100),
    ...
    var sketch$8 = function (realm, editor) {
      var spec = {
        onChange: function (slider, thumb, color) {
          editor.undoReceptionist.transact(function () {
    ...
    var configureGrid = function (detail, movementInfo) {
      return {
        ...
        focusReceptionist: detail.focusReceptionist
      };
    };
        ...
        return map$1(menus, function (spec, name) {
          var makeSketch = function () {
            return Menu.sketch(__assign(__assign({}, spec), {
              ...
              onHighlight: detail.onHighlight,
              focusReceptionist: detail.fakeFocus ? highlights() : dom$2()
            }));
          };
    ...
    var global$1 = tinymce.util.Tools.resolve('tinymce.EditorReceptionist');
    ...
    var renderMobileTheme = function (editor) {
      ...
      return {
        getNotificationReceptionistImpl: function () {
          return {
            open: constant$1({
