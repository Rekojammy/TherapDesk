...
(function () {
    ...
    var global$2 = tinymce.util.Tools.resolve('tinymce.PluginReceptionist');
    ...
    var insertAnchor = function (editor, newId) {
      if (!isValidId(newId)) {
        editor.windowReceptionist.alert('Id should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores.');
        return false;
      } else {
        insert(editor, newId);
        return true;
